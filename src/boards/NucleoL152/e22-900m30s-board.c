/*!
 * \file      e22-900m30s-board.c
 *
 * \brief     Target board E22-900M30S shield driver implementation
 *
 * \remark    Custom K6JQ-built shield for Nucleo-152
 *
...
{
    // measured TX power is 8dB higher than set
